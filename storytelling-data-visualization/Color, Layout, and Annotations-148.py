...
for sp in range(0,4):
    ...
    cb_bright_orange = (255/255,128/255,14/255)
    ax.plot(women_degrees['Year'], women_degrees[major_cats[sp]], label='Women', c=cb_dark_blue)
    ax.plot(women_degrees['Year'], 100-women_degrees[major_cats[sp]],label='Men',c=cb_bright_orange)
